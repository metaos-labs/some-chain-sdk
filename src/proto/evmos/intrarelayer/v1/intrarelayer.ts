...
export enum Owner {
  ...
  OWNER_UNSPECIFIED = 0,
  /** OWNER_MODULE - OWNER_MODULE erc20 is owned by the intrarelayer module account. */
  OWNER_MODULE = 1,
...
export const TokenPair = {
  ...
  fromJSON(object: any): TokenPair {
    return {
      erc20Address: isSet(object.erc20Address)
        ? String(object.erc20Address)
        : "",
      denom: isSet(object.denom) ? String(object.denom) : "",
      enabled: isSet(object.enabled) ? Boolean(object.enabled) : false,
      contractOwner: isSet(object.contractOwner)
  ...
  fromPartial<I extends Exact<DeepPartial<TokenPair>, I>>(
    object: I
  ): TokenPair {
    const message = createBaseTokenPair();
...
export const RegisterCoinProposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<RegisterCoinProposal>, I>>(
    object: I
  ): RegisterCoinProposal {
    const message = createBaseRegisterCoinProposal();
...
export const RegisterERC20Proposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<RegisterERC20Proposal>, I>>(
    object: I
  ): RegisterERC20Proposal {
    const message = createBaseRegisterERC20Proposal();
    message.title = object.title ?? "";
...
export const ToggleTokenRelayProposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<ToggleTokenRelayProposal>, I>>(
    object: I
  ): ToggleTokenRelayProposal {
    const message = createBaseToggleTokenRelayProposal();
    message.title = object.title ?? "";
...
function createBaseUpdateTokenPairERC20Proposal(): UpdateTokenPairERC20Proposal {
  return { title: "", description: "", erc20Address: "", newErc20Address: "" };
}
...
export const UpdateTokenPairERC20Proposal = {
  ...
  fromJSON(object: any): UpdateTokenPairERC20Proposal {
    return {
      ...
      erc20Address: isSet(object.erc20Address)
        ? String(object.erc20Address)
        : "",
      newErc20Address: isSet(object.newErc20Address)
        ? String(object.newErc20Address)
        : "",
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateTokenPairERC20Proposal>, I>>(
    object: I
  ): UpdateTokenPairERC20Proposal {
    const message = createBaseUpdateTokenPairERC20Proposal();
    message.title = object.title ?? "";
