...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      claimsRecords: Array.isArray(object?.claimsRecords)
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.claimsRecords) {
      obj.claimsRecords = message.claimsRecords.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.params =
      object.params !== undefined && object.params !== null
        ...
        : undefined;
    message.claimsRecords =
      object.claimsRecords?.map((e) => ClaimsRecordAddress.fromPartial(e)) ||
      [];
    return message;
  },
};
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      enableClaims: isSet(object.enableClaims)
        ? Boolean(object.enableClaims)
        : false,
      ...
      authorizedChannels: Array.isArray(object?.authorizedChannels)
        ? object.authorizedChannels.map((e: any) => String(e))
        : [],
      evmChannels: Array.isArray(object?.evmChannels)
        ? object.evmChannels.map((e: any) => String(e))
        : [],
    };
  },
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.enableClaims !== undefined &&
