...
export declare namespace MsgSubmitProposal {
    ...
    const Proto: {
        encode(message: MsgSubmitProposal_pb, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number | undefined): MsgSubmitProposal_pb;
        fromJSON(object: any): MsgSubmitProposal_pb;
        toJSON(message: MsgSubmitProposal_pb): unknown;
        fromPartial<I extends {
            ...
            content?: ({
                ...
                typeUrl?: string | undefined;
                value?: Uint8Array | undefined;
            } & Record<Exclude<keyof I["content"], "typeUrl" | "value">, never>) | undefined;
            initialDeposit?: ({
                denom?: string | undefined;
                amount?: string | undefined;
            }[] & ({
                ...
                denom?: string | undefined;
                amount?: string | undefined;
            } & Record<Exclude<keyof I["initialDeposit"][number], "denom" | "amount">, never>)[] & Record<Exclude<keyof I["initialDeposit"], number | "length" | "toString" | "toLocaleString" | "pop" | "push" | "concat" | "join" | "reverse" | "shift" | "slice" | "sort" | "splice" | "unshift" | "indexOf" | "lastIndexOf" | "every" | "some" | "forEach" | "map" | "filter" | "reduce" | "reduceRight" | "find" | "findIndex" | "fill" | "copyWithin" | "entries" | "keys" | "values" | "includes" | "flatMap" | "flat" | "at">, never>) | undefined;
            proposer?: string | undefined;
        } & Record<Exclude<keyof I, "content" | "initialDeposit" | "proposer">, never>>(object: I): MsgSubmitProposal_pb;
    };
    interface Proto extends MsgSubmitProposal_pb {
    }
}
...
export declare namespace MsgDeposit {
    const typeUrl: string;
    const Proto: {
        encode(message: MsgDeposit_pb, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number | undefined): MsgDeposit_pb;
        fromJSON(object: any): MsgDeposit_pb;
        toJSON(message: MsgDeposit_pb): unknown;
        fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I, "amount" | "proposalId" | "depositor">, never>>(object: I): MsgDeposit_pb;
    };
    interface Proto extends MsgDeposit_pb {
    }
}
...
export declare namespace MsgVote {
    const typeUrl: string;
    const Proto: {
        encode(message: MsgVote_pb, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number | undefined): MsgVote_pb;
        fromJSON(object: any): MsgVote_pb;
        toJSON(message: MsgVote_pb): unknown;
        fromPartial<I extends {
            proposalId?: string | number | import("long").Long | undefined;
            voter?: string | undefined;
            option?: import("../proto/cosmos/gov/v1beta1/gov").VoteOption | undefined;
        } & {
            proposalId?: string | number | (import("long").Long & {
                high: number;
                low: number;
            ...
            voter?: string | undefined;
            option?: import("../proto/cosmos/gov/v1beta1/gov").VoteOption | undefined;
        } & Record<Exclude<keyof I, "proposalId" | "voter" | "option">, never>>(object: I): MsgVote_pb;
    };
    interface Proto extends MsgVote_pb {
    }
}
...
export declare namespace MsgVoteWeighted {
    const typeUrl: string;
    const Proto: {
        encode(message: MsgVoteWeighted_pb, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number | undefined): MsgVoteWeighted_pb;
        fromJSON(object: any): MsgVoteWeighted_pb;
        toJSON(message: MsgVoteWeighted_pb): unknown;
        fromPartial<I extends {
            proposalId?: string | number | import("long").Long | undefined;
            voter?: string | undefined;
            options?: {
            ...
            options?: ({
                ...
                option?: import("../proto/cosmos/gov/v1beta1/gov").VoteOption | undefined;
                weight?: string | undefined;
            } & Record<Exclude<keyof I["options"][number], "option" | "weight">, never>)[] & Record<Exclude<keyof I["options"], number | "length" | "toString" | "toLocaleString" | "pop" | "push" | "concat" | "join" | "reverse" | "shift" | "slice" | "sort" | "splice" | "unshift" | "indexOf" | "lastIndexOf" | "every" | "some" | "forEach" | "map" | "filter" | "reduce" | "reduceRight" | "find" | "findIndex" | "fill" | "copyWithin" | "entries" | "keys" | "values" | "includes" | "flatMap" | "flat" | "at">, never>) | undefined;
        } & Record<Exclude<keyof I, "proposalId" | "voter" | "options">, never>>(object: I): MsgVoteWeighted_pb;
    };
    interface Proto extends MsgVoteWeighted_pb {
    }
}
