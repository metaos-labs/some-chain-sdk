...
export enum AuthorizationType {
  ...
  /**
   * AUTHORIZATION_TYPE_UNDELEGATE - AUTHORIZATION_TYPE_UNDELEGATE defines an authorization type for
   * Msg/Undelegate
   */
  AUTHORIZATION_TYPE_UNDELEGATE = 2,
  /**
   * AUTHORIZATION_TYPE_REDELEGATE - AUTHORIZATION_TYPE_REDELEGATE defines an authorization type for
   * Msg/BeginRedelegate
   */
