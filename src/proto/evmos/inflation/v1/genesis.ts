...
export const GenesisState = {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.epochsPerPeriod !== undefined &&
      (obj.epochsPerPeriod = (message.epochsPerPeriod || Long.ZERO).toString());
  ...
  fromJSON(object: any): Params {
    return {
      ...
      inflationDistribution: isSet(object.inflationDistribution)
        ...
        : undefined,
      enableInflation: isSet(object.enableInflation)
        ? Boolean(object.enableInflation)
        : false,
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.inflationDistribution !== undefined &&
      (obj.inflationDistribution = message.inflationDistribution
        ...
        : undefined);
    message.enableInflation !== undefined &&
