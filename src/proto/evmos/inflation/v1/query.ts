...
export const QueryTotalSupplyResponse = {
  encode(
    ...
    if (message.totalSupply !== undefined) {
      DecCoin.encode(message.totalSupply, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryTotalSupplyResponse {
    return {
      totalSupply: isSet(object.totalSupply)
        ? DecCoin.fromJSON(object.totalSupply)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryTotalSupplyResponse): unknown {
    ...
    message.totalSupply !== undefined &&
      (obj.totalSupply = message.totalSupply
        ? DecCoin.toJSON(message.totalSupply)
        : undefined);
    return obj;
  },
...
export interface Query {
  ...
  Period(
    request: DeepPartial<QueryPeriodRequest>,
    metadata?: grpc.Metadata
  ): Promise<QueryPeriodResponse>;
  /** EpochMintProvision retrieves current minting epoch provision value. */
  EpochMintProvision(
    request: DeepPartial<QueryEpochMintProvisionRequest>,
    metadata?: grpc.Metadata
  ): Promise<QueryEpochMintProvisionResponse>;
  /** SkippedEpochs retrieves the total number of skipped epochs. */
  SkippedEpochs(
    request: DeepPartial<QuerySkippedEpochsRequest>,
    metadata?: grpc.Metadata
  ...
  InflationRate(
    request: DeepPartial<QueryInflationRateRequest>,
    metadata?: grpc.Metadata
...
export class QueryClientImpl implements Query {
  ...
  Period(
    ...
    return this.rpc.unary(
      QueryPeriodDesc,
      QueryPeriodRequest.fromPartial(request),
      metadata
    );
  }
  ...
  EpochMintProvision(
    ...
    return this.rpc.unary(
      QueryEpochMintProvisionDesc,
      QueryEpochMintProvisionRequest.fromPartial(request),
      metadata
    );
  }
  ...
  SkippedEpochs(
    ...
    return this.rpc.unary(
      QuerySkippedEpochsDesc,
      QuerySkippedEpochsRequest.fromPartial(request),
      metadata
    );
  }
  ...
  InflationRate(
    ...
    return this.rpc.unary(
      QueryInflationRateDesc,
      QueryInflationRateRequest.fromPartial(request),
      metadata
    );
  }
