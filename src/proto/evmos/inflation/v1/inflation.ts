...
export const InflationDistribution = {
  ...
  fromJSON(object: any): InflationDistribution {
    return {
      stakingRewards: isSet(object.stakingRewards)
        ...
        : "",
      usageIncentives: isSet(object.usageIncentives)
        ? String(object.usageIncentives)
        : "",
  ...
  toJSON(message: InflationDistribution): unknown {
    ...
    message.usageIncentives !== undefined &&
...
export const ExponentialCalculation = {
  ...
  fromJSON(object: any): ExponentialCalculation {
    return {
      ...
      bondingTarget: isSet(object.bondingTarget)
        ? String(object.bondingTarget)
        : "",
  ...
  toJSON(message: ExponentialCalculation): unknown {
    ...
    message.bondingTarget !== undefined &&
      (obj.bondingTarget = message.bondingTarget);
    message.maxVariance !== undefined &&
