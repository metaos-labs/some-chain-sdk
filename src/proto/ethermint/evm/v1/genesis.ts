...
import { Params, TransactionLogs, State } from "./evm";
...
function createBaseGenesisState(): GenesisState {
  return { accounts: [], params: undefined, txsLogs: [] };
}
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      txsLogs: Array.isArray(object?.txsLogs)
        ? object.txsLogs.map((e: any) => TransactionLogs.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.params =
      object.params !== undefined && object.params !== null
        ...
        : undefined;
    message.txsLogs =
      object.txsLogs?.map((e) => TransactionLogs.fromPartial(e)) || [];
    return message;
  },
};
...
export const GenesisAccount = {
  ...
  fromJSON(object: any): GenesisAccount {
    return {
      ...
      storage: Array.isArray(object?.storage)
        ? object.storage.map((e: any) => State.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisAccount>, I>>(
    object: I
  ): GenesisAccount {
    const message = createBaseGenesisAccount();
