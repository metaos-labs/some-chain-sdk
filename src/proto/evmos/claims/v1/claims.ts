...
export const Claim = {
  ...
  fromJSON(object: any): Claim {
    return {
      ...
      claimableAmount: isSet(object.claimableAmount)
        ? String(object.claimableAmount)
        : "",
    };
  },
...
export const ClaimsRecordAddress = {
  ...
  fromJSON(object: any): ClaimsRecordAddress {
    return {
      ...
      initialClaimableAmount: isSet(object.initialClaimableAmount)
        ...
        : "",
      actionsCompleted: Array.isArray(object?.actionsCompleted)
        ? object.actionsCompleted.map((e: any) => Boolean(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ClaimsRecordAddress>, I>>(
    object: I
  ): ClaimsRecordAddress {
    const message = createBaseClaimsRecordAddress();
...
export const ClaimsRecord = {
  ...
  fromPartial<I extends Exact<DeepPartial<ClaimsRecord>, I>>(
    object: I
  ): ClaimsRecord {
    const message = createBaseClaimsRecord();
    message.initialClaimableAmount = object.initialClaimableAmount ?? "";
