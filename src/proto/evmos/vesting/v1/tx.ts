...
export const MsgCreateClawbackVestingAccountResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgCreateClawbackVestingAccountResponse>, I>
  >(_: I): MsgCreateClawbackVestingAccountResponse {
    const message = createBaseMsgCreateClawbackVestingAccountResponse();
    return message;
  },
};
...
export const MsgClawbackResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgClawbackResponse>, I>>(
    _: I
  ): MsgClawbackResponse {
    const message = createBaseMsgClawbackResponse();
    return message;
...
export interface Msg {
  ...
  CreateClawbackVestingAccount(
    request: DeepPartial<MsgCreateClawbackVestingAccount>,
    metadata?: grpc.Metadata
  ): Promise<MsgCreateClawbackVestingAccountResponse>;
  /** Clawback removes the unvested tokens from a ClawbackVestingAccount. */
  Clawback(
    request: DeepPartial<MsgClawback>,
    metadata?: grpc.Metadata
  ): Promise<MsgClawbackResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateClawbackVestingAccount(
    ...
    return this.rpc.unary(
      MsgCreateClawbackVestingAccountDesc,
      MsgCreateClawbackVestingAccount.fromPartial(request),
      metadata
    );
  }
  ...
  Clawback(
    ...
    return this.rpc.unary(
      MsgClawbackDesc,
      MsgClawback.fromPartial(request),
      metadata
    );
  }
}
